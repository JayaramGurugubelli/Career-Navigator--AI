...
import careerpilot_parent.interviewexperience.dto.request.ModerateInterviewExperienceRequest;
...
import careerpilot_parent.interviewexperience.mapper.InterviewExperienceMapper;
...
import careerpilot_parent.interviewexperience.service.InterviewExperienceService;
...
public class InterviewExperienceServiceImpl
    ...
    private void validateQuestionOrders(
        ...
        for (Object object : questions) {
            ...
            var question =
                    (careerpilot_parent.interviewexperience.dto.request.CreateInterviewQuestionRequest)
                            object;
