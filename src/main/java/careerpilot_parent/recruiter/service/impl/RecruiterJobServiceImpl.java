...
public class RecruiterJobServiceImpl
    ...
    public Page<JobPostingResponse> getMyJobs(
        ...
        if (status == null) {
            ...
            jobs =
                    jobRepository.findByRecruiterId(
                            recruiter.getId(),
                            pageable
                    );
    ...
    public JobPostingResponse closeJob(
        ...
        if (job.getStatus() ==
            ...
            throw new IllegalStateException(
                    "Job is already closed or archived."
            );
        }
    ...
    public void archiveJob(
        ...
        if (job.getStatus() ==
            ...
            throw new IllegalStateException(
                    "Close or pause the job before archiving it."
            );
        }
