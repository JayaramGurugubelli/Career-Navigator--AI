...
public class CreateJobPostingRequest {
    ...
    @Size(
            max = 15000,
            message = "Responsibilities must not exceed 15000 characters"
    )
    private String responsibilities;

    @Size(
            max = 15000,
            message = "Qualifications must not exceed 15000 characters"
    )
    private String qualifications;

    @Size(
            max = 15000,
            message = "Preferred qualifications must not exceed 15000 characters"
    )
